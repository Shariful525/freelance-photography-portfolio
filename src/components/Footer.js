    ...
    <footer className="footer footer-center p-10  text-base-content rounded">
      <div className="w-7/12">
        <div>
          ...
          <p className="opacity-[0.70] text-white text-[18px] mt-5 leading-7">
        ...
        <div className="grid grid-flow-col gap-4 text-white text-[18px] my-12">
        ...
        <div className="btm-footer">
          <p className="text-2xl">hello@expersquad.net</p>
        </div>
      </div>
    </footer>
  );
